...
$news = new \News('новости', 'Lorem Ipsum не случайная комбинация латинских слов. 
Впервые он был упомянут в одном из фрагментов классической латыни в 45 году нашей эры.
 ...
 написанной Цицероном в 45 году н.э. Этот трактат был посвящен теории этики и имел популярность в эпоху Возрождения.', '12.13.2020');
$article = new \Articles('статья', 'Lorem Ipsum не случайная комбинация латинских слов.
...
$announcement = new \Announcements('обьявление', 'Lorem Ipsum не случайная комбинация латинских слов. 
